...
int
machine_at_vp1543_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vp1543/20641108.bin",
                           0x000e0000, 131072, 0);
...
machine_at_m5ala_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/m5ala/Ala1122b.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_hot591p_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hot591p/591PS025.BIN",
                           0x000e0000, 131072, 0);
