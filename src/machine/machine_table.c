...
const machine_t machines[] = {
  // clang-format off
    ...
    /* 430NX */
    {
        .name = "[i430NX] AMI ATLAS PCI Pentium ISA",
        .internal_name = "s721",
        .type = MACHINE_TYPE_SOCKET5,
        .chipset = MACHINE_CHIPSET_INTEL_430NX,
        .init = machine_at_s721_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 5501] AOpen AP5CS",
        .internal_name = "ap5cs",
        .type = MACHINE_TYPE_SOCKET5,
        .chipset = MACHINE_CHIPSET_SIS_5501,
        .init = machine_at_ap5cs_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 5501] EFA P54CSPIO",
        .internal_name = "p54cspio",
        .type = MACHINE_TYPE_SOCKET5,
        .chipset = MACHINE_CHIPSET_SIS_5501,
        .init = machine_at_p54cspio_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
