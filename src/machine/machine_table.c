...

{
    ...
    {
        .name = "[i440BX] Siemens Nixdorf Xpert 79xx",
        .internal_name = "acerv66xa",
        .type = MACHINE_TYPE_SLOT1,
        .chipset = MACHINE_CHIPSET_INTEL_440BX,
        .init = machine_at_acerv66xa_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL | MACHINE_SOUND | MACHINE_GAMEPORT | MACHINE_APM,
        .ram = {
            .min = 8192,
            .max = 393216,
            .step = 8192
        ...
        .fdc_device = NULL,
        .sio_device = NULL,
        .vid_device = NULL, /* ATi Rage Pro Turbo AGP onboard video not emulated yet */
        .snd_device = &cs4235_onboard_device,
        .net_device = NULL
    },
