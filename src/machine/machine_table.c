...
const machine_t machines[] = {
  // clang-format off
	...
	/* Has onboard ATi video which is not emulated yet */
    {
        .name = "[i430VX] Gateway 2000 Mailman",
        .internal_name = "mailman",
        .type = MACHINE_TYPE_SOCKET7_3V,
        .chipset = MACHINE_CHIPSET_INTEL_430VX,
        .init = machine_at_mailman_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL | MACHINE_APM | MACHINE_SOUND,
        .ram = {
            .min = 8192,
            .max = 65536,
            .step = 8192
    ...
    },
    {
        ...
        .bus_flags = MACHINE_PS2_PCI | MACHINE_BUS_USB,
        .flags = MACHINE_IDE_DUAL | MACHINE_SOUND | MACHINE_APM | MACHINE_ACPI | MACHINE_USB, /* Machine has internal video: Intel i740 */
        .ram = {
            .min = 8192,
            .max = 786432,
            .step = 8192
