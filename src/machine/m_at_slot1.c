...
int
machine_at_hot637a_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hot637a/637awiqc.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_hot679_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hot679/6790S01F.BIN",
                           0x000c0000, 262144, 0);
    ...
    pci_register_slot(0x00, PCI_CARD_NORTHBRIDGE, 0, 0, 0, 0);
    pci_register_slot(0x07, PCI_CARD_SOUTHBRIDGE, 1, 2, 3, 4);
    pci_register_slot(0x0F, PCI_CARD_SOUND,       4, 1, 2, 3);
    pci_register_slot(0x08, PCI_CARD_NORMAL,      1, 2, 3, 4);
    pci_register_slot(0x09, PCI_CARD_NORMAL,      2, 3, 4, 1);
    pci_register_slot(0x0A, PCI_CARD_NORMAL,      3, 4, 1, 2);
    pci_register_slot(0x01, PCI_CARD_AGPBRIDGE,   1, 2, 3, 4);
...
int
machine_at_zxbs1_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/zxbs1/B1120IAG.BIN",
                           0x000c0000, 262144, 0);
    ...
    pci_register_slot(0x00, PCI_CARD_NORTHBRIDGE, 0, 0, 0, 0);
    pci_register_slot(0x07, PCI_CARD_SOUTHBRIDGE, 1, 2, 3, 4);
    pci_register_slot(0x0F, PCI_CARD_SOUND,       3, 4, 1, 2);
    pci_register_slot(0x08, PCI_CARD_NORMAL,      1, 2, 3, 4);
    pci_register_slot(0x09, PCI_CARD_NORMAL,      2, 3, 4, 1);
    pci_register_slot(0x0A, PCI_CARD_NORMAL,      3, 4, 1, 2);
    pci_register_slot(0x01, PCI_CARD_AGPBRIDGE,   1, 2, 3, 4);
