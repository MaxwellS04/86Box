...
int
machine_at_pegasus_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/pegasus/S759P.ROM",
                           0x000e0000, 131072, 0);
...
int
machine_at_portland_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear_combined2("roms/machines/portland/1009DT0_.BIO",
                                     "roms/machines/portland/1009DT0_.BI1",
                                     "roms/machines/portland/1009DT0_.BI2",
                                     "roms/machines/portland/1009DT0_.BI3",
                                     "roms/machines/portland/1009DT0_.RCV",
                                     0x3a000, 128);
