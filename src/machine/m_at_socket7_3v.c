...
int
machine_at_s1468_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/s1468/fx68401b.bin",
                           0x000e0000, 131072, 0);
    ...
    device_add(&fdc37c665_device); /* This has possibly FDC37C665 Super I/O? */
    device_add(&sst_flash_29ee010_device);
...
int
machine_at_marl_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear_combined("roms/machines/marl/1008DB0_.bio",
                                    "roms/machines/marl/1008DB0_.bi1",
                                    0x1d000, 128);
...
int
machine_at_8500tax_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/8500tax/TAX0109B.ROM",
                           0x000e0000, 131072, 0);
...
machine_at_mailman_init(const machine_t *model)
{
    ...
    ret = bios_load_linear_combined2("roms/machines/mailman/1007DQ0T.BIO",
                                     "roms/machines/mailman/1007DQ0T.BI1",
                                     "roms/machines/mailman/1007DQ0T.BI2",
                                     "roms/machines/mailman/1007DQ0T.BI3",
                                     "roms/machines/mailman/1007DQ0T.RCV",
                                     0x3a000, 128);
...
int
machine_at_pip55sp4_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/pip55sp4/0312-1.BIN",
                           0x000e0000, 131072, 0);
