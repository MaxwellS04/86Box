...
int
machine_at_ga586hx_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga586hx/5HX29P4.BIN",
                           0x000e0000, 131072, 0);
...
int
machine_at_ga586svx_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ga586svx/SVX106.BIN",
                           0x000e0000, 131072, 0);
...
int
machine_at_p5txla_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/p5txla/TXLA11.BIN",
                           0x000c0000, 262144, 0);
...
int
machine_at_hot595_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/hot595/595wiq03.bin",
                           0x000e0000, 131072, 0);
