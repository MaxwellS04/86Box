...
video_cards[] = {
  // clang-format off
    ...
    { .device = &s3_winner1000_928_isa_device,                  .flags = VIDEO_FLAG_TYPE_NONE },
    { .device = &s3_winner2000_928_isa_device,                  .flags = VIDEO_FLAG_TYPE_NONE },
    ...
    { .device = &s3_winner2000_pro_pci_device,                  .flags = VIDEO_FLAG_TYPE_NONE },
