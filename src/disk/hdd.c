...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Eastern Electric M54A",                   .internal_name = "EASTM54A", .model = "EASTERN ELETRIC M54AT", .zones =  8,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.0A",                  .internal_name = "EASTM10A", .model = "EASTERN ELETRIC M1.0A", .zones =  8,  .avg_spt = 130, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.2A",                  .internal_name = "EASTM12A", .model = "EASTERN ELETRIC M1.2A", .zones =  16,  .avg_spt = 150, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.6A",                  .internal_name = "EASTM16A", .model = "EASTERN ELETRIC M1.6A", .zones =  16,  .avg_spt = 170, .heads = 4, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M2.1A",                  .internal_name = "EASTM21A", .model = "EASTERN ELETRIC M2.1A", .zones =  16,  .avg_spt = 170, .heads = 5, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
