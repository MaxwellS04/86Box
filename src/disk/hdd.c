...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Shorthorn S30AT",                         .internal_name = "S30AT", .model = "S30AT R1", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[Custom] Shorthorn S40AT",                         .internal_name = "S40AT", .model = "S40AT R1", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[Custom] Shorthorn S60AT",                         .internal_name = "S40AT", .model = "S40AT R1", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
