...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Arabitech Tower (ARA3240T)",              .internal_name = "ARA3240T", .model = "ARABTECH ARA3240T", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4500, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Arabitech Tower (ARA4320T)",              .internal_name = "ARA4320T", .model = "ARABTECH ARA4320T", .zones =  8,  .avg_spt = 190, .heads = 5, .rpm = 4500, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Arabitech Qua (ARA4321Q)",                .internal_name = "ARA4321Q", .model = "ARABTECH ARA4321Q", .zones =  8,  .avg_spt = 210, .heads = 5, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    { .name = "[Custom] Arabitech Qua (ARA6441Q)",                .internal_name = "ARA6441Q", .model = "ARABTECH ARA6441Q", .zones =  8,  .avg_spt = 210, .heads = 6, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    { .name = "[Custom] Astral Arch (ARCHP64A)",                  .internal_name = "ARCHP64A", .model = "ASTRAL TECHNOLOGIES ARCHP64A", .zones =  8,  .avg_spt = 250, .heads = 3, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    { .name = "[Custom] Astral Arch (ARCHP84A)",                  .internal_name = "ARCHP84A", .model = "ASTRAL TECHNOLOGIES ARCHP84A", .zones =  8,  .avg_spt = 250, .heads = 4, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    ...
    { .name = "[Custom] Eastern Electric M54AT",                  .internal_name = "EASTM54A", .model = "EASTERN ELETRIC M54AT", .zones =  8,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M85AT",                  .internal_name = "EASTM85A", .model = "EASTERN ELETRIC M85AT", .zones =  8,  .avg_spt = 130, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.0AT",                 .internal_name = "EASTM10A", .model = "EASTERN ELETRIC M1.0A", .zones =  16,  .avg_spt = 150, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.2AT",                 .internal_name = "EASTM12A", .model = "EASTERN ELETRIC M1.2A", .zones =  16,  .avg_spt = 150, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M1.6AT",                 .internal_name = "EASTM16A", .model = "EASTERN ELETRIC M1.6A", .zones =  16,  .avg_spt = 170, .heads = 4, .rpm = 4200, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M2.1AT",                 .internal_name = "EASTM21A", .model = "EASTERN ELETRIC M2.1A", .zones =  16,  .avg_spt = 170, .heads = 5, .rpm = 4200, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric 4gdi",                   .internal_name = "EAST4GDI", .model = "EASTERN ELETRIC 4G", .zones =  16,  .avg_spt = 210, .heads = 3, .rpm = 5400, .full_stroke_ms = 23, .track_seek_ms = 3,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Eastern Electric 6ddi",                   .internal_name = "EAST6DDI", .model = "EASTERN ELETRIC 6G", .zones =  16,  .avg_spt = 250, .heads = 5, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Eastern Electric 8ddi",                   .internal_name = "EAST8DDI", .model = "EASTERN ELETRIC 8G", .zones =  16,  .avg_spt = 250, .heads = 6, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Eastern Electric Excellence",             .internal_name = "EAST10EX", .model = "EASTERN ELETRIC 10G", .zones =  16,  .avg_spt = 310, .heads = 5, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    ...
    { .name = "[Custom] Goldhawk Edison GH40AT",                  .internal_name = "GH40AT", .model = "GOLDHAWK GH40 AT", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[Custom] Goldhawk Martha GH41AT",                  .internal_name = "GH41AT", .model = "GOLDHAWK GH41 AT", .zones =  4,  .avg_spt = 90, .heads = 1, .rpm = 3600, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Martha GH61AT",                  .internal_name = "GH61AT", .model = "GOLDHAWK GH61 AT", .zones =  4,  .avg_spt = 90, .heads = 2, .rpm = 3600, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Martha GH131AT",                 .internal_name = "GH131AT", .model = "GOLDHAWK GH131 AT", .zones =  4,  .avg_spt = 90, .heads = 3, .rpm = 3600, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Washington GH243AT",             .internal_name = "GH243AT", .model = "GOLDHAWK GH243 AT", .zones =  4,  .avg_spt = 110, .heads = 2, .rpm = 3661, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Bush GH540AT",                   .internal_name = "GH540AT", .model = "GOLDHAWK GH540 AT", .zones =  4,  .avg_spt = 133, .heads = 2, .rpm = 4000, .full_stroke_ms = 25, .track_seek_ms = 3.7,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Bush GH640AT",                   .internal_name = "GH640AT", .model = "GOLDHAWK GH640 AT", .zones =  4,  .avg_spt = 133, .heads = 3, .rpm = 4000, .full_stroke_ms = 25, .track_seek_ms = 3.7,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[Custom] Goldhawk Bush GH850AT",                   .internal_name = "GH850AT", .model = "GOLDHAWK GH850 AT", .zones =  4,  .avg_spt = 133, .heads = 4, .rpm = 4000, .full_stroke_ms = 25, .track_seek_ms = 3.7,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[Custom] Goldhawk Newman GH1275AT",                .internal_name = "GH1275AT", .model = "GOLDHAWK GH1275 AT", .zones =  8,  .avg_spt = 170, .heads = 3, .rpm = 4200, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Newman GH1720AT",                .internal_name = "GH1720AT", .model = "GOLDHAWK GH1720 AT", .zones =  8,  .avg_spt = 170, .heads = 4, .rpm = 4200, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Newman GH2160AT",                .internal_name = "GH2160AT", .model = "GOLDHAWK GH2160 AT", .zones =  8,  .avg_spt = 170, .heads = 5, .rpm = 4200, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Sukhbaatar GH1720XL",            .internal_name = "GH1720XL", .model = "GOLDHAWK GH1720 XL", .zones =  8,  .avg_spt = 195, .heads = 4, .rpm = 5400, .full_stroke_ms = 20, .track_seek_ms = 2.7,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Lincoln GH2100AT",               .internal_name = "GH2100AT", .model = "GOLDHAWK GH2100 AT", .zones =  8,  .avg_spt = 230, .heads = 3, .rpm = 5200, .full_stroke_ms = 20, .track_seek_ms = 2.3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Lincoln GH3200AT",               .internal_name = "GH3200AT", .model = "GOLDHAWK GH3200 AT", .zones =  8,  .avg_spt = 230, .heads = 4, .rpm = 5200, .full_stroke_ms = 20, .track_seek_ms = 2.3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Lincoln GH4300AT",               .internal_name = "GH4300AT", .model = "GOLDHAWK GH4300 AT", .zones =  8,  .avg_spt = 230, .heads = 5, .rpm = 5200, .full_stroke_ms = 20, .track_seek_ms = 2.3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Goldhawk Reagan GH4300XL",                .internal_name = "GH4300XL", .model = "GOLDHAWK GH4300 XL", .zones =  12,  .avg_spt = 290, .heads = 4, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    { .name = "[Custom] Goldhawk Reagan GH6400XL",                .internal_name = "GH6400XL", .model = "GOLDHAWK GH6400 XL", .zones =  12,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    { .name = "[Custom] Goldhawk Reagan GH8400XL",                .internal_name = "GH8400XL", .model = "GOLDHAWK GH8400 XL", .zones =  12,  .avg_spt = 290, .heads = 6, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    ...
    { .name = "[Custom] Lime Hills F11000AT",                     .internal_name = "F11000AT", .model = "LIME HILLS F11000AT", .zones =  8,  .avg_spt = 150, .heads = 2, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  8 },
    { .name = "[Custom] Lime Hills F11200AT",                     .internal_name = "F11200AT", .model = "LIME HILLS F11200AT", .zones =  8,  .avg_spt = 150, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  8 },
    { .name = "[Custom] Lime Hills F11600AT",                     .internal_name = "F11600AT", .model = "LIME HILLS F11600AT", .zones =  8,  .avg_spt = 150, .heads = 4, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  8 },
    { .name = "[Custom] Lime Hills F12048AI",                     .internal_name = "F12048AI", .model = "LIME HILLS F12048AI", .zones =  8,  .avg_spt = 170, .heads = 3, .rpm = 4000, .full_stroke_ms = 25, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lime Hills Starlight",                    .internal_name = "F36400SL", .model = "LIME HILLS F36400SL Starlight", .zones =  16,  .avg_spt = 250, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Century 240XL",                   .internal_name = "LCN240X", .model = "LYCORIS CENTURY 240 XL", .zones =  8,  .avg_spt = 130, .heads = 2, .rpm = 3660, .full_stroke_ms = 25, .track_seek_ms = 3.3,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Lycoris Century 540XL",                   .internal_name = "LCN540X", .model = "LYCORIS CENTURY 540 XL", .zones =  8,  .avg_spt = 150, .heads = 3, .rpm = 3660, .full_stroke_ms = 25, .track_seek_ms = 3.3,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Lycoris Century 850XL",                   .internal_name = "LCN850X", .model = "LYCORIS CENTURY 850 XL", .zones =  8,  .avg_spt = 150, .heads = 4, .rpm = 3660, .full_stroke_ms = 25, .track_seek_ms = 3.3,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Lycoris Wonder 1.2FX",                    .internal_name = "LCWF12FX", .model = "LYCORIS WONDER 1.2 FX", .zones =  8,  .avg_spt = 170, .heads = 2, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[Custom] Lycoris Centro 1.2G",                     .internal_name = "LCT12GB", .model = "Lycoris CENTRO 1.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 3, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 2.1G",                     .internal_name = "LCT21GB", .model = "Lycoris CENTRO 2.1G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 3.2G",                     .internal_name = "LCT32GB", .model = "Lycoris CENTRO 3.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 5, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lycoris Centro 6.4G",                     .internal_name = "LCT64GB", .model = "Lycoris Centro Series", .zones =  16,  .avg_spt = 295, .heads = 6, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 8.4G",                     .internal_name = "LCT84GB", .model = "Lycoris Centro Series", .zones =  16,  .avg_spt = 310, .heads = 8, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro Plus 6.8G",                .internal_name = "LCTP68GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 5, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 10.2G",               .internal_name = "LCTP102GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 6, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 13.0G",               .internal_name = "LCTP130GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 8, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Newlink NWK2OC27",                        .internal_name = "NWK2OC27", .model = "NEWLINK NWK2OC27", .zones =  4,  .avg_spt = 150, .heads = 1, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[Custom] Newlink NWK2OC54",                        .internal_name = "NWK2OC54", .model = "NEWLINK NWK2OC54", .zones =  4,  .avg_spt = 150, .heads = 2, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[Custom] Newlink NWK2OC85",                        .internal_name = "NWK2OC85", .model = "NEWLINK NWK2OC85", .zones =  4,  .avg_spt = 150, .heads = 3, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[Custom] Newlink SWiFT 1G",                        .internal_name = "NWK2SW1A", .model = "NEWLINK NWK2SW1A", .zones =  8,  .avg_spt = 150, .heads = 2, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Newlink SWiFT 2G",                        .internal_name = "NWK2SW2A", .model = "NEWLINK NWK2SW2A", .zones =  8,  .avg_spt = 150, .heads = 3, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Newlink SWiFT 3G",                        .internal_name = "NWK2SW3A", .model = "NEWLINK NWK2SW3A", .zones =  8,  .avg_spt = 150, .heads = 4, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Newlink Hyperblast 3G",                   .internal_name = "NWK3HB3A", .model = "NEWLINK NWK3HB3A", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Hyperblast 4G",                   .internal_name = "NWK3HB4A", .model = "NEWLINK NWK3HB4A", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M04A)",          .internal_name = "NWK4M44A", .model = "NEWLINK NWK4M44A", .zones =  16,  .avg_spt = 235, .heads = 4, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M06A)",          .internal_name = "NWK4M46A", .model = "NEWLINK NWK4M46A", .zones =  16,  .avg_spt = 235, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Newlink eXpert 300",                      .internal_name = "NWK5X306A", .model = "NEWLINK eXpert NWK3H06A", .zones =  16,  .avg_spt = 295, .heads = 6, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size = 1024, .max_multiple =  32 },
    { .name = "[Custom] Newlink eXpert 400 (NWK5H06A)",           .internal_name = "NWK5X406A", .model = "NEWLINK eXpert NWK5H06A", .zones =  16,  .avg_spt = 310, .heads = 6, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    { .name = "[Custom] Newlink eXpert 400 (NWK5H08A)",           .internal_name = "NWK5X408A", .model = "NEWLINK eXpert NWK5H08A", .zones =  16,  .avg_spt = 310, .heads = 8, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    ...
    { .name = "[Custom] Novatech NVH-1024M",                      .internal_name = "NVH1024M", .model = "NOVATECH HDD NVH 1024M", .zones =  8,  .avg_spt = 210, .heads = 2, .rpm = 5400, .full_stroke_ms = 23, .track_seek_ms = 3,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Novatech NVH-2048M",                      .internal_name = "NVH2048M", .model = "NOVATECH HDD NVH 2048M", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5400, .full_stroke_ms = 23, .track_seek_ms = 3,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Novatech NVH-3200M",                      .internal_name = "NVH3200M", .model = "NOVATECH HDD NVH 3200M", .zones =  8,  .avg_spt = 250, .heads = 3, .rpm = 5200, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Novatech NVH-4400M",                      .internal_name = "NVH4400M", .model = "NOVATECH HDD NVH 4400M", .zones =  8,  .avg_spt = 250, .heads = 4, .rpm = 5200, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Novatech NVH-6400M",                      .internal_name = "NVH6400M", .model = "NOVATECH HDD NVH 6400M", .zones =  16,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Novatech NVH-8400M",                      .internal_name = "NVH8400M", .model = "NOVATECH HDD NVH 8400M", .zones =  16,  .avg_spt = 290, .heads = 6, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
