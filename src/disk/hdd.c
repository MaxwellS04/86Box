...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Eastern Electric M1.0AT",                 .internal_name = "EASTM10A", .model = "EASTERN ELETRIC M1.0A", .zones =  8,  .avg_spt = 130, .heads = 3, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    ...
    { .name = "[Custom] Eastern Electric M1.6AT",                 .internal_name = "EASTM16A", .model = "EASTERN ELETRIC M1.6A", .zones =  16,  .avg_spt = 170, .heads = 4, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M2.1AT",                 .internal_name = "EASTM21A", .model = "EASTERN ELETRIC M2.1A", .zones =  16,  .avg_spt = 170, .heads = 5, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lycoris Centro Server 1.2G",              .internal_name = "LCT12GBS", .model = "Lycoris CENTRO 1.2G SERVER", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.3,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro Server 2.1G",              .internal_name = "LCT21GBS", .model = "Lycoris CENTRO 2.1G SERVER", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.3,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink DiVA Star",                       .internal_name = "NWK5DV06A", .model = "NEWLINK DiVA Star HD", .zones =  16,  .avg_spt = 350, .heads = 6, .rpm = 7200, .full_stroke_ms = 11, .track_seek_ms = 1,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[Custom] Newlink DiVA Star PRO",                   .internal_name = "NWK5DV10A", .model = "NEWLINK DiVA Star PRO HD", .zones =  16,  .avg_spt = 350, .heads = 8, .rpm = 7200, .full_stroke_ms = 11, .track_seek_ms = 1,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
