...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom 1995] Astral 512MB CF Card Rev. 1.3b",   .internal_name = "A512MCFCARD_13b", .model = "512M CF CARD (c)1995 ASTRAL MEDIA CORP. JAPAN",                                         .rcache_num_seg = 4, .rcache_seg_size = 64, .max_multiple = 16 },
    { .name = "[Custom 1995] Astral 512MB CF Card Rev. 2.21",   .internal_name = "A512MCFCARD_221", .model = "512M CF CARD v2.21 (c)1995 Astral Media Corp.",                                         .rcache_num_seg = 8, .rcache_seg_size = 64, .max_multiple = 16 },
    { .name = "[Custom 1996] Astral 512MB CF Card Rev. 2.60",   .internal_name = "A512MCFCARD_260", .model = "512M CF CARD v2.60 (c)1996 Astral Media Corp.",                                         .rcache_num_seg = 8, .rcache_seg_size = 64, .max_multiple = 16 },
    { .name = "[Custom 1995] Astral 1GB CF Card Rev. 2.3c",     .internal_name = "A1GBCFCARD_23c", .model = "1G CF CARD v2.3C (c)1995 Astral Media Corp.",                                         .rcache_num_seg = 16, .rcache_seg_size = 128, .max_multiple = 32 },
    { .name = "[Custom 1996] Astral 1GB CF Card Rev. 2.48",     .internal_name = "A1GBCFCARD_248", .model = "1G CF CARD v2.48 (c)1996 Astral Media Corp.",                                         .rcache_num_seg = 16, .rcache_seg_size = 128, .max_multiple = 32 },
    { .name = "[Custom 1996] Astral 1GB CF Card Rev. 2.51",     .internal_name = "A1GBCFCARD_251", .model = "1G CF CARD v2.51 (c)1996 Astral Media Corp.",                                         .rcache_num_seg = 16, .rcache_seg_size = 128, .max_multiple = 32 },
    { .name = "[Custom 1997] Astral 1GB CF Card Rev. 3.1a",     .internal_name = "A1GBCFCARD_31a", .model = "1G CF CARD v3.1A (c)1997 Astral Media Corp.",                                         .rcache_num_seg = 16, .rcache_seg_size = 128, .max_multiple = 32 },
    { .name = "[Custom 1996] Astral 2GB CF Card",               .internal_name = "A2GBCFCARD", .model = "2G CF CARD v3.0 (c)1996 Astral Media Corp.",                                         .rcache_num_seg = 16, .rcache_seg_size = 128, .max_multiple = 32 },
