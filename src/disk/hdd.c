...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-2] Hitachi DK223A-11",                        .internal_name = "DK223A11", .model = "HITACHI DK223A-11", .zones =  4,  .avg_spt = 120, .heads = 3, .rpm = 4464, .full_stroke_ms = 30, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
