...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[PIO IDE] Quantum ProDrive ELS (42AT)",            .internal_name = "ELS42AT", .model = "QUANTUM PRODRIVE 42AT", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3600, .full_stroke_ms = 28, .track_seek_ms = 3,   .rcache_num_seg =  1, .rcache_seg_size =  8, .max_multiple =  1 },
