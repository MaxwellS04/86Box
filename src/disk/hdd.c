...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Shorthorn S128AT",                        .internal_name = "S128AT", .model = "SHORTHORN S128AT-R5", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
