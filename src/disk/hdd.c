...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[PIO IDE] Seagate SWIFT (ST1239A)",                .internal_name = "ST1239A", .model = "ST1239A", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  1 },
    ...
    { .name = "[ATA-2] Connor CFA-540A",                          .internal_name = "CFA540A", .model = "Connor Peripherals 540MB - CFA540A", .zones =  2,  .avg_spt = 120, .heads = 4, .rpm = 3551, .full_stroke_ms = 31, .track_seek_ms = 4.3,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  8 },
    ...
    { .name = "[ATA-3] Connor CFS-1275A",                         .internal_name = "CFS1275A", .model = "Connor Peripherals 1275MB - CFS1275A", .zones =  4,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 3.8,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  16 }, // Either ATA-2 or ATA-3
