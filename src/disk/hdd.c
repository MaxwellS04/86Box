...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 6.4G",                     .internal_name = "LCT64GB", .model = "Lycoris Centro Series", .zones =  12,  .avg_spt = 295, .heads = 4, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 8.4G",                     .internal_name = "LCT84GB", .model = "Lycoris Centro Series", .zones =  12,  .avg_spt = 310, .heads = 5, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro Plus 6.8G",                .internal_name = "LCTP68GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 4, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 10.2G",               .internal_name = "LCTP102GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 5, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 13.0G",               .internal_name = "LCTP130GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 315, .heads = 6, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
