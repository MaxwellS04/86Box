...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Southern SHD60160T",                      .internal_name = "SHD60160", .model = "SOUTHERN SHD60160", .zones =  4,  .avg_spt = 70, .heads = 2, .rpm = 3553, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
