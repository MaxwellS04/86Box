...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-3] Conner CFS-1275A",                         .internal_name = "CFS1275A", .model = "Conner Peripherals 1275MB - CFS1275A", .zones =  4,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 3.8,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  16 }, // Either ATA-2 or ATA-3
    ...
    { .name = "[ATA-2] Toshiba MK-2101MAN (HDD2616)",             .internal_name = "HDD2616", .model = "TOSHIBA MK2101MAN", .zones =  8,  .avg_spt = 130, .heads = 10, .rpm = 4200, .full_stroke_ms = 36, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307015)",         .internal_name = "DTLA307015", .model = "IBM-DTLA-307015", .zones =  15,  .avg_spt = 285, .heads = 2, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307020)",         .internal_name = "DTLA307020", .model = "IBM-DTLA-307020", .zones =  15,  .avg_spt = 285, .heads = 3, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307030)",         .internal_name = "DTLA307030", .model = "IBM-DTLA-307030", .zones =  15,  .avg_spt = 285, .heads = 4, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307045)",         .internal_name = "DTLA307045", .model = "IBM-DTLA-307045", .zones =  15,  .avg_spt = 285, .heads = 6, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307060)",         .internal_name = "DTLA307060", .model = "IBM-DTLA-307060", .zones =  15,  .avg_spt = 285, .heads = 8, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] IBM Deskstar 75GXP (DTLA-307075)",         .internal_name = "DTLA307075", .model = "IBM-DTLA-307075", .zones =  15,  .avg_spt = 285, .heads = 10, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    ...
    { .name = "[ATA-6] Seagate U Series 5 - 15GB",                .internal_name = "ST315311A", .model = "ST315311A", .zones =  16,  .avg_spt = 389, .heads = 1, .rpm = 5400, .full_stroke_ms = 24, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] Seagate U Series 5 - 20GB",                .internal_name = "ST320413A", .model = "ST320413A", .zones =  16,  .avg_spt = 389, .heads = 1, .rpm = 5400, .full_stroke_ms = 24, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] Seagate U Series 5 - 30GB",                .internal_name = "ST330621A", .model = "ST330621A", .zones =  16,  .avg_spt = 389, .heads = 1, .rpm = 5400, .full_stroke_ms = 24, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    { .name = "[ATA-6] Seagate U Series 5 - 50GB",                .internal_name = "ST340823A", .model = "ST340823A", .zones =  16,  .avg_spt = 389, .heads = 1, .rpm = 5400, .full_stroke_ms = 24, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
