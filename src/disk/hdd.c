...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 6.4G",                     .internal_name = "LCT64GB", .model = "Lycoris Centro Series", .zones =  16,  .avg_spt = 290, .heads = 6, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro 8.4G",                     .internal_name = "LCT84GB", .model = "Lycoris Centro Series", .zones =  16,  .avg_spt = 310, .heads = 8, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  32 },
    ...
    { .name = "[Custom] Newlink NWK2OC54",                        .internal_name = "NWK2OC54", .model = "NEWLINK NWK2OC54", .zones =  4,  .avg_spt = 150, .heads = 3, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[Custom] Shorthorn S128AT",                        .internal_name = "S128AT", .model = "SHORTHORN S128AT-R5", .zones =  4,  .avg_spt = 50, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
