...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-6] Samsung SpinPoint V20",                    .internal_name = "SV2042HV20", .model = "SAMSUNG SV2042H", .zones =  16,  .avg_spt = 308, .heads = 2, .rpm = 5400, .full_stroke_ms = 17, .track_seek_ms = 0.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
