...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Seagate ST325A",                           .internal_name = "ST325A", .model = "ST325A", .zones =  1,  .avg_spt = 263, .heads = 1, .rpm = 3048, .full_stroke_ms = 33, .track_seek_ms = 4.4,   .rcache_num_seg =  1, .rcache_seg_size =  8, .max_multiple =  8 }, // There is also a XTA version
    { .name = "[ATA-1] Seagate ST351A",                           .internal_name = "ST351A", .model = "ST351A", .zones =  2,  .avg_spt = 263, .heads = 1, .rpm = 3048, .full_stroke_ms = 33, .track_seek_ms = 4.4,   .rcache_num_seg =  1, .rcache_seg_size =  8, .max_multiple =  8 }, // There is also a XTA version
    ...
    { .name = "[ATA-2] Western Digital Caviar 32500",                .internal_name = "AC32500", .model = "WDC AC32500LA", .zones =  8,  .avg_spt = 130, .heads = 3, .rpm = 5200, .full_stroke_ms = 30, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
