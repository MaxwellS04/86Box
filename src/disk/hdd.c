...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Conner CP-30174E",                         .internal_name = "CP30174E", .model = "Conner Peripherals 170MB - CP30174E", .zones =  1,  .avg_spt = 70, .heads = 4, .rpm = 3822, .full_stroke_ms = 42, .track_seek_ms = 3,   .rcache_num_seg = 4, .rcache_seg_size = 32, .max_multiple =  8 },
    ...
    { .name = "[ATA-1] Conner CFN-250A",                          .internal_name = "CFN250A", .model = "Conner Peripherals 252MB - CFN250A", .zones =  4,  .avg_spt = 120, .heads = 6, .rpm = 4498, .full_stroke_ms = 34, .track_seek_ms = 2.6,   .rcache_num_seg = 4, .rcache_seg_size = 32, .max_multiple =  8 },
    { .name = "[ATA-1] Conner CFN-340A",                          .internal_name = "CFN340A", .model = "Conner Peripherals 344MB - CFN340A", .zones =  4,  .avg_spt = 130, .heads = 6, .rpm = 4500, .full_stroke_ms = 34, .track_seek_ms = 3,   .rcache_num_seg = 4, .rcache_seg_size = 32, .max_multiple =  8 },
    { .name = "[ATA-1] Conner CP-3364",                           .internal_name = "CP3364", .model = "Conner Peripherals 362MB - CP3364", .zones =  4,  .avg_spt = 120, .heads = 8, .rpm = 4498, .full_stroke_ms = 40, .track_seek_ms = 3,   .rcache_num_seg = 4, .rcache_seg_size = 256, .max_multiple =  8 },
