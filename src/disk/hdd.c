...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Newlink Hyperblast 3G",                   .internal_name = "NWK3HB03A", .model = "NEWLINK NWK3HB03A", .zones =  16,  .avg_spt = 210, .heads = 3, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Hyperblast 4G",                   .internal_name = "NWK3HB04A", .model = "NEWLINK NWK3HB04A", .zones =  16,  .avg_spt = 210, .heads = 4, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink eXpert 300",                      .internal_name = "NWK5X306A", .model = "NEWLINK eXpert NWK3H06A", .zones =  16,  .avg_spt = 295, .heads = 6, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size = 1024, .max_multiple =  32 },
    { .name = "[Custom] Newlink eXpert 400 (NWK5H06A)",           .internal_name = "NWK5X406A", .model = "NEWLINK eXpert NWK5H06A", .zones =  16,  .avg_spt = 310, .heads = 6, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    { .name = "[Custom] Newlink eXpert 400 (NWK5H08A)",           .internal_name = "NWK5X408A", .model = "NEWLINK eXpert NWK5H08A", .zones =  16,  .avg_spt = 310, .heads = 8, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
