...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-5] Samsung SpinPoint V9100 (SV0682D)",        .internal_name = "SV0431D", .model = "SAMSUNG SV0431D", .zones =  8,  .avg_spt = 185, .heads = 1, .rpm = 5400, .full_stroke_ms = 16, .track_seek_ms = 0.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[ATA-5] Samsung SpinPoint V9100 (SV1023D)",        .internal_name = "SV0842D", .model = "SAMSUNG SV0842D", .zones =  8,  .avg_spt = 185, .heads = 2, .rpm = 5400, .full_stroke_ms = 16, .track_seek_ms = 0.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[ATA-5] Samsung SpinPoint V9100 (SV1364D)",        .internal_name = "SV1363D", .model = "SAMSUNG SV1363D", .zones =  8,  .avg_spt = 185, .heads = 3, .rpm = 5400, .full_stroke_ms = 16, .track_seek_ms = 0.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[ATA-5] Samsung SpinPoint V9100 (SV1705D)",        .internal_name = "SV1824D", .model = "SAMSUNG SV1824D", .zones =  8,  .avg_spt = 185, .heads = 4, .rpm = 5400, .full_stroke_ms = 16, .track_seek_ms = 0.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
