...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Eastern Electric 4gdi",                   .internal_name = "EAST4GDI", .model = "EASTERN ELETRIC 4G", .zones =  16,  .avg_spt = 210, .heads = 2, .rpm = 5400, .full_stroke_ms = 23, .track_seek_ms = 3,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 5400, .full_stroke_ms = 22, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Shorthorn S30AT",                         .internal_name = "S30AT", .model = "30AT R1", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[Custom] Shorthorn S40AT",                         .internal_name = "S40AT", .model = "40AT R1", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[Custom] Shorthorn S128AT",                        .internal_name = "S128AT", .model = "SHORTHORN 128AT-R5", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
