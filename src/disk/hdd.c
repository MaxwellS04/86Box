...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-2] Seagate Medalist 420xe",                   .internal_name = "ST3491A", .model = "ST3491A", .zones =  4,  .avg_spt = 152, .heads = 3, .rpm = 3811, .full_stroke_ms = 30, .track_seek_ms = 4.4,   .rcache_num_seg =  8, .rcache_seg_size =  120, .max_multiple =  8 },
