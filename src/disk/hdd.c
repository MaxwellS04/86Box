...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 3.2G",                     .internal_name = "LCT32GB", .model = "Lycoris CENTRO 3.2G HDD", .zones =  8,  .avg_spt = 230, .heads = 4, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 250, .heads = 4, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
