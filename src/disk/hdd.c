...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 4.3G (Rev. 1)",            .internal_name = "LCT43GB1", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G (Rev. 2)",            .internal_name = "LCT43GB2", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.3,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G (Rev. 3)",            .internal_name = "LCT43GB3", .model = "Lycoris Centro Series", .zones =  8,  .avg_spt = 290, .heads = 3, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink Dynamite (NWK2DY1A)",             .internal_name = "NWK2DY1A", .model = "NEWLINK NWK2DY1A", .zones =  4,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 25, .track_seek_ms = 3.3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  8 },
