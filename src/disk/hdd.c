...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Seagate ST3145A",                          .internal_name = "ST3145A", .model = "ST3145A", .zones =  2,  .avg_spt = 64, .heads = 2, .rpm = 3811, .full_stroke_ms = 32, .track_seek_ms = 4.3,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  8 },
