...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Western Digital Caviar 1210",              .internal_name = "AC1210", .model = "AC1210F", .zones =  4,  .avg_spt = 30, .heads = 2, .rpm = 3314, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[ATA-1] Western Digital Caviar 1365",              .internal_name = "AC1365", .model = "AC1365F", .zones =  2,  .avg_spt = 135, .heads = 2, .rpm = 4200, .full_stroke_ms = 28, .track_seek_ms = 2.8,   .rcache_num_seg =  4, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[ATA-1] Western Digital Caviar 1425",              .internal_name = "AC1425", .model = "AC1425F", .zones =  4,  .avg_spt = 120, .heads = 2, .rpm = 4200, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[ATA-1] Western Digital Caviar 2120",              .internal_name = "AC2120", .model = "AC2120M", .zones =  4,  .avg_spt = 40, .heads = 2, .rpm = 3605, .full_stroke_ms = 28, .track_seek_ms = 2.8,   .rcache_num_seg =  8, .rcache_seg_size =  32, .max_multiple =  8 },
    { .name = "[ATA-1] Western Digital Caviar 2340",              .internal_name = "AC2340", .model = "AC2340H", .zones =  4,  .avg_spt = 130, .heads = 2, .rpm = 3320, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[ATA-1] Western Digital Caviar 2420",              .internal_name = "AC2420", .model = "AC2420F", .zones =  4,  .avg_spt = 130, .heads = 2, .rpm = 3314, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[ATA-4] Western Digital Caviar 33100",             .internal_name = "AC33100", .model = "WDC AC33100L", .zones =  16,  .avg_spt = 210, .heads = 4, .rpm = 5200, .full_stroke_ms = 40, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  32 },
