...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lime Hills Starlight",                    .internal_name = "F46400SL", .model = "LIME HILLS F46400SL Starlight", .zones =  16,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Shorthorn S30AT",                         .internal_name = "S30AT", .model = "S30AT R1", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    ...
    { .name = "[Custom] Shorthorn S245XTR",                       .internal_name = "S245XTR", .model = "SHORTHORN S245XTR-R2", .zones =  8,  .avg_spt = 70, .heads = 3, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Shorthorn S528AT",                        .internal_name = "S528AT", .model = "SHORTHORN S528AT-R3", .zones =  8,  .avg_spt = 90, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
