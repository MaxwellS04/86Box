...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Conner CP-30084E",                         .internal_name = "CP30084E", .model = "Conner Peripherals 80MB - CP30084E", .zones =  1,  .avg_spt = 70, .heads = 2, .rpm = 3595, .full_stroke_ms = 50, .track_seek_ms = 3,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  8 },
    ...
    { .name = "[ATA-1] Conner CP-30124",                          .internal_name = "CP30124", .model = "Conner Peripherals 126MB - CP30124", .zones =  1,  .avg_spt = 40, .heads = 2, .rpm = 4542, .full_stroke_ms = 26, .track_seek_ms = 3,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  8 },
    ...
    { .name = "[Custom] Eastern Electric M54AT",                  .internal_name = "EASTM54A", .model = "EASTERN ELETRIC M54AT", .zones =  2,  .avg_spt = 130, .heads = 1, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Eastern Electric M85AT",                  .internal_name = "EASTM85A", .model = "EASTERN ELETRIC M85AT", .zones =  2,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 28, .track_seek_ms = 5,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lycoris Centro 1.2G",                     .internal_name = "LCT12GB", .model = "Lycoris CENTRO 1.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 2, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 2.1G",                     .internal_name = "LCT21GB", .model = "Lycoris CENTRO 2.1G HDD", .zones =  8,  .avg_spt = 190, .heads = 3, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 3.2G",                     .internal_name = "LCT32GB", .model = "Lycoris CENTRO 3.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4000, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 210, .heads = 5, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.3,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lycoris Centro ULTIMATE 17.2G",           .internal_name = "LCTU172GB", .model = "Lycoris Centro ULTIMATE Series", .zones =  16,  .avg_spt = 350, .heads = 8, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro ULTIMATE 20.6G",           .internal_name = "LCTU206GB", .model = "Lycoris Centro ULTIMATE Series", .zones =  16,  .avg_spt = 350, .heads = 10, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple =  32 },
    ...
    { .name = "[Custom] Lycoris Railgun 4.3G",                    .internal_name = "LCT43GB", .model = "Lycoris Railgun Series", .zones =  15,  .avg_spt = 290, .heads = 5, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Railgun 6.4G",                    .internal_name = "LCT63GB", .model = "Lycoris Railgun Series", .zones =  15,  .avg_spt = 290, .heads = 6, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Railgun 8.4G",                    .internal_name = "LCT84GB", .model = "Lycoris Railgun Series", .zones =  15,  .avg_spt = 290, .heads = 8, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple =  32 },
    ...
    { .name = "[Custom] Reflectia Saturn (RHE3240PRO)",           .internal_name = "RHE3240PRO", .model = "REFLECTIA RHE3240 PRO", .zones = 16,  .avg_spt = 210, .heads = 6, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    ...
    { .name = "[Custom] Southern Supreme (SHD905211SU)",          .internal_name = "SHD905211SU", .model = "SOUTHERN SHD905211SU", .zones =  12,  .avg_spt = 290, .heads = 4, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple = 32 },
    { .name = "[Custom] Southern Supreme (SHD906831SU)",          .internal_name = "SHD906831SU", .model = "SOUTHERN SHD906831SU", .zones =  12,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple = 32 },
    { .name = "[Custom] Southern Supreme (SHD910241SU)",          .internal_name = "SHD910241SU", .model = "SOUTHERN SHD910241SU", .zones =  12,  .avg_spt = 290, .heads = 6, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple = 32 },
    { .name = "[Custom] Southern Supreme (SHD913661SU)",          .internal_name = "SHD913661SU", .model = "SOUTHERN SHD913661SU", .zones =  12,  .avg_spt = 290, .heads = 8, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple = 32 },
    { .name = "[Custom] Southern Supreme (SHD915311SU)",          .internal_name = "SHD915311SU", .model = "SOUTHERN SHD915311SU", .zones =  12,  .avg_spt = 290, .heads = 10, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 1.8,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple = 32 },
    { .name = "[Custom] Southern Storm (SHD910240ST)",            .internal_name = "SHD910240ST", .model = "SOUTHERN SHD910240ST", .zones =  16,  .avg_spt = 350, .heads = 5, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple = 32 },
    { .name = "[Custom] Southern Storm (SHD913030ST)",            .internal_name = "SHD913030ST", .model = "SOUTHERN SHD913030ST", .zones =  16,  .avg_spt = 350, .heads = 6, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple = 32 },
    { .name = "[Custom] Southern Storm (SHD917240ST)",            .internal_name = "SHD917240ST", .model = "SOUTHERN SHD917240ST", .zones =  16,  .avg_spt = 350, .heads = 8, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple = 32 },
    { .name = "[Custom] Southern Storm (SHD920460ST)",            .internal_name = "SHD920460ST", .model = "SOUTHERN SHD920460ST", .zones =  16,  .avg_spt = 350, .heads = 10, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  1024, .max_multiple = 32 },
   // clang-format on
};
