...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-1] Conner CP-341",                            .internal_name = "CP341", .model = "Conner Peripherals 40MB - CP341", .zones =  1,  .avg_spt = 40, .heads = 2, .rpm = 3500, .full_stroke_ms = 50, .track_seek_ms = 8,   .rcache_num_seg =  1, .rcache_seg_size =  8, .max_multiple =  1 },
    ...
    { .name = "[ATA-5] Western Digital Expert 100BA",             .internal_name = "WD100BA", .model = "WDC WD100BA-60AK", .zones =  16,  .avg_spt = 350, .heads = 6, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
