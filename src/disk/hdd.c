...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.3,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 6.4G",                     .internal_name = "LCT64GB", .model = "Lycoris Centro Series", .zones =  8,  .avg_spt = 295, .heads = 4, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 8.4G",                     .internal_name = "LCT84GB", .model = "Lycoris Centro Series", .zones =  8,  .avg_spt = 310, .heads = 5, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
