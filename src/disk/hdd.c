...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-5] Western Digital Caviar 100BA",             .internal_name = "WD100BA", .model = "WDC WD100BA-60AGA0", .zones =  16,  .avg_spt = 310, .heads = 6, .rpm = 7200, .full_stroke_ms = 12, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Lycoris Centro Plus 6.8G",                .internal_name = "LCTP68GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 350, .heads = 5, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 10.2G",               .internal_name = "LCTP102GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 350, .heads = 6, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Lycoris Centro Plus 13.0G",               .internal_name = "LCTP130GB", .model = "Lycoris Centro PLUS Series", .zones =  16,  .avg_spt = 350, .heads = 8, .rpm = 7200, .full_stroke_ms = 18, .track_seek_ms = 1.7,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Shorthorn S80AT",                         .internal_name = "S80AT", .model = "S80AT R1", .zones =  1,  .avg_spt = 50, .heads = 3, .rpm = 3551, .full_stroke_ms = 33, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
