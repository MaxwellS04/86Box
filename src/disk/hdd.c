...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-2] Seagate Medalist 2160 Pro",                .internal_name = "ST52160A", .model = "ST52160A", .zones =  16,  .avg_spt = 120, .heads = 4, .rpm = 5400, .full_stroke_ms = 25, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[ATA-2] Seagate Medalist 2520 Pro",                .internal_name = "ST52520A", .model = "ST52520A", .zones =  16,  .avg_spt = 120, .heads = 4, .rpm = 5400, .full_stroke_ms = 25, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[ATA-2] Western Digital Caviar 31600",             .internal_name = "AC31600", .model = "WDC AC31600H", .zones =  8,  .avg_spt = 120, .heads = 4, .rpm = 5200, .full_stroke_ms = 12, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  16 },
    ...
    { .name = "[ATA-4] Fujitsu MPD3108AT",                        .internal_name = "MPD3108AT", .model = "FUJITSU MPD3108AT", .zones =  7,  .avg_spt = 295, .heads = 5, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[ATA-4] Fujitsu MPD3129AT",                        .internal_name = "MPD3129AT", .model = "FUJITSU MPD3129AT", .zones =  7,  .avg_spt = 295, .heads = 6, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[ATA-4] Fujitsu MPD3173AT",                        .internal_name = "MPD3173AT", .model = "FUJITSU MPD3173AT", .zones =  7,  .avg_spt = 295, .heads = 8, .rpm = 5400, .full_stroke_ms = 19, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    ...
    { .name = "[ATA-4] Seagate Medalist 6530 Pro",                .internal_name = "ST36530A", .model = "ST36530A", .zones =  16,  .avg_spt = 295, .heads = 6, .rpm = 7200, .full_stroke_ms = 21, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[ATA-5] IBM/Hitachi Travelstar 12GN",              .internal_name = "DARA212000", .model = "IBM-DARA-212000", .zones =  12,  .avg_spt = 312, .heads = 4, .rpm = 4200, .full_stroke_ms = 31, .track_seek_ms = 4,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 }, // Either Hitachi or IBM OEM
