...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 190, .heads = 6, .rpm = 5400, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink Hyperblast 3G",                   .internal_name = "NWK3HB03A", .model = "NEWLINK NWK3HB03A", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Hyperblast 4G",                   .internal_name = "NWK3HB04A", .model = "NEWLINK NWK3HB04A", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M04A)",          .internal_name = "NWK4M404A", .model = "NEWLINK MAXFORCE NWK4M404A", .zones =  16,  .avg_spt = 290, .heads = 4, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M06A)",          .internal_name = "NWK4M406A", .model = "NEWLINK MAXFORCE NWK4M406A", .zones =  16,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  32 },
