...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lycoris Century 240XL",                   .internal_name = "LCN240X", .model = "LYCORIS CENTURY 240 XL", .zones =  8,  .avg_spt = 150, .heads = 2, .rpm = 3660, .full_stroke_ms = 25, .track_seek_ms = 3.3,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
    ...
    { .name = "[Custom] Lycoris Centro 1.2G",                     .internal_name = "LCT12GB", .model = "Lycoris CENTRO 1.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 2, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 2.1G",                     .internal_name = "LCT21GB", .model = "Lycoris CENTRO 2.1G HDD", .zones =  8,  .avg_spt = 190, .heads = 3, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 3.2G",                     .internal_name = "LCT32GB", .model = "Lycoris CENTRO 3.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 210, .heads = 6, .rpm = 5400, .full_stroke_ms = 22, .track_seek_ms = 2.4,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink NWK2OC54",                        .internal_name = "NWK2OC54", .model = "NEWLINK NWK2OC54", .zones =  4,  .avg_spt = 150, .h, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  8, .rcache_seg_size =  512, .max_multiple =  16 },
    ...
    { .name = "[Custom] Shorthorn S128AT",                        .internal_name = "S128AT", .model = "SHORTHORN S128AT-R5", .zones =  4,  .avg_spt = 50, .heads = 2, .rpm = eads = 2, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 3.5,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    { .name = "[Custom] Shorthorn S131XTR",                       .internal_name = "S131XTR", .model = "SHORTHORN S131XTR-R2", .zones =  8,  .avg_spt = 70, .heads = 3, .rpm = 4000, .full_stroke_ms = 28, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  64, .max_multiple =  8 },
