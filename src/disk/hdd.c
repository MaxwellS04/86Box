...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[PIO IDE] Westen Digital WD93024-A",               .internal_name = "WD93024A", .model = "WDC WD93024A", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Westen Digital WD93044-A",               .internal_name = "WD93044A", .model = "WDC WD93044A", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    ...
    { .name = "[Custom] Newlink Hyperblast 3G",                   .internal_name = "NWK3HB03A", .model = "NEWLINK NWK3HB03A", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Hyperblast 4G",                   .internal_name = "NWK3HB04A", .model = "NEWLINK NWK3HB04A", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5200, .full_stroke_ms = 18, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  16 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M04A)",          .internal_name = "NWK4M404A", .model = "NEWLINK MAXFORCE NWK4M404A", .zones =  16,  .avg_spt = 290, .heads = 4, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    { .name = "[Custom] Newlink Maxforce M4 (NWK4M06A)",          .internal_name = "NWK4M406A", .model = "NEWLINK MAXFORCE NWK4M406A", .zones =  16,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Shorthorn S128AT",                        .internal_name = "S128AT", .model = "SHORTHORN S128AT-R5", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
    { .name = "[Custom] Shorthorn S528AT",                        .internal_name = "S528AT", .model = "SHORTHORN S528AT-R3", .zones =  8,  .avg_spt = 90, .heads = 2, .rpm = 3600, .full_stroke_ms = 30, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  64, .max_multiple =  8 },
   // clang-format on
};
