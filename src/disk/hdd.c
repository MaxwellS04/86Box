...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[Custom] Lime Hills F2048AT",                      .internal_name = "F2048AT", .model = "LIME HILLS F2048AT", .zones =  8,  .avg_spt = 150, .heads = 2, .rpm = 4000, .full_stroke_ms = 25, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  16 },
    { .name = "[Custom] Lime Hills Starlight",                    .internal_name = "F6400SL", .model = "LIME HILLS F6400SL Starlight", .zones =  16,  .avg_spt = 290, .heads = 5, .rpm = 5400, .full_stroke_ms = 15, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  512, .max_multiple =  32 },
    ...
    { .name = "[Custom] Lycoris Centro 2.1G",                     .internal_name = "LCT21GB", .model = "Lycoris CENTRO 2.1G HDD", .zones =  8,  .avg_spt = 190, .heads = 3, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 3.2G",                     .internal_name = "LCT32GB", .model = "Lycoris CENTRO 3.2G HDD", .zones =  8,  .avg_spt = 190, .heads = 4, .rpm = 4500, .full_stroke_ms = 22, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro 4.3G",                     .internal_name = "LCT43GB", .model = "Lycoris CENTRO 4.3G HDD", .zones =  8,  .avg_spt = 190, .heads = 6, .rpm = 5400, .full_stroke_ms = 22, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Lycoris Centro Server 1.2G",              .internal_name = "LCT12GBS", .model = "Lycoris CENTRO 1.2G SERVER", .zones =  8,  .avg_spt = 210, .heads = 3, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    { .name = "[Custom] Lycoris Centro Server 2.1G",              .internal_name = "LCT21GBS", .model = "Lycoris CENTRO 2.1G SERVER", .zones =  8,  .avg_spt = 210, .heads = 4, .rpm = 5400, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[Custom] Newlink eXpert 300",                      .internal_name = "NWK5X306A", .model = "NEWLINK eXpert NWK3H06A", .zones =  16,  .avg_spt = 295, .heads = 6, .rpm = 7200, .full_stroke_ms = 15, .track_seek_ms = 1.5,   .rcache_num_seg =  16, .rcache_seg_size = 1024, .max_multiple =  32 },
