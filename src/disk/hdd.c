...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[PIO IDE] Quantum ProDrive ELS",                   .internal_name = "ELS42AT", .model = "QUANTUM PRODRIVE ELS", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3600, .full_stroke_ms = 28, .track_seek_ms = 3,   .rcache_num_seg =  1, .rcache_seg_size =  8, .max_multiple =  1 },
    ...
    { .name = "[ATA-1] Quantum ProDrive LPS 120AT",               .internal_name = "GM12A012", .model = "QUANTUM PRODRIVE 120AT", .zones =  2,  .avg_spt = 50, .heads = 2, .rpm = 3605, .full_stroke_ms = 45, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =  64, .max_multiple =  8 },
    ...
    { .name = "[ATA-2] Quantum ProDrive LPS 270AT",               .internal_name = "QT270AT", .model = "QUANTUM PRODRIVE LPS", .zones =  2,  .avg_spt = 130, .heads = 2, .rpm = 4500, .full_stroke_ms = 45, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[ATA-2] Seagate Medalist 1270SL",                  .internal_name = "ST51270A", .model = "ST51270A", .zones =  8,  .avg_spt = 205, .heads = 6, .rpm = 5736, .full_stroke_ms = 25, .track_seek_ms = 2,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  16 },
    ...
    { .name = "[ATA-6] Western Digital Caviar 102BB",             .internal_name = "WD102BB", .model = "WDC WD102BB-00BCB0", .zones =  16,  .avg_spt = 285, .heads = 2, .rpm = 7200, .full_stroke_ms = 23, .track_seek_ms = 2.0,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
    ...
    { .name = "[Custom] Arabitech Tower (ARA3240T)",              .internal_name = "ARA3240T", .model = "ARABTECH ARA3240T", .zones =  4,  .avg_spt = 190, .heads = 3, .rpm = 4500, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Arabitech Tower (ARA4320T)",              .internal_name = "ARA4320T", .model = "ARABTECH ARA4320T", .zones =  4,  .avg_spt = 190, .heads = 4, .rpm = 4500, .full_stroke_ms = 21, .track_seek_ms = 2.5,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 16 },
    { .name = "[Custom] Arabitech Qua (ARA4321Q)",                .internal_name = "ARA4321Q", .model = "ARABTECH ARA4321Q", .zones =  4,  .avg_spt = 210, .heads = 4, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    { .name = "[Custom] Arabitech Qua (ARA6441Q)",                .internal_name = "ARA6441Q", .model = "ARABTECH ARA6441Q", .zones =  4,  .avg_spt = 210, .heads = 5, .rpm = 5400, .full_stroke_ms = 18, .track_seek_ms = 2,   .rcache_num_seg =  16, .rcache_seg_size =  256, .max_multiple = 32 },
    ...
    { .name = "[Custom] Astral Ultima (ULTP170A)",                .internal_name = "ULTP170A", .model = "ASTRAL TECHNOLOGIES ULTP170A", .zones =  16,  .avg_spt = 370, .heads = 6, .rpm = 7200, .full_stroke_ms = 13, .track_seek_ms = 1.3,   .rcache_num_seg =  16, .rcache_seg_size =  2048, .max_multiple =  32 },
