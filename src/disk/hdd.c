...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[PIO IDE] Seagate SWIFT (ST1090A)",                .internal_name = "ST1090A", .model = "ST1090A", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3600, .full_stroke_ms = 35, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Seagate SWIFT (ST1126A)",                .internal_name = "ST1126A", .model = "ST1126A", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3600, .full_stroke_ms = 35, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Seagate SWIFT (ST1162A)",                .internal_name = "ST1162A", .model = "ST1162A", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3600, .full_stroke_ms = 35, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Seagate SWIFT (ST1186A)",                .internal_name = "ST1186A", .model = "ST1186A", .zones =  1,  .avg_spt = 33, .heads = 1, .rpm = 3600, .full_stroke_ms = 35, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Seagate SWIFT (ST1201A)",                .internal_name = "ST1201A", .model = "ST1201A", .zones =  1,  .avg_spt = 50, .heads = 1, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =  32, .max_multiple =  1 },
    { .name = "[PIO IDE] Seagate SWIFT (ST1239A)",                .internal_name = "ST1239A", .model = "ST1239A", .zones =  1,  .avg_spt = 50, .heads = 2, .rpm = 3600, .full_stroke_ms = 33, .track_seek_ms = 4,   .rcache_num_seg =  4, .rcache_seg_size =  32, .max_multiple =  1 },
    ...
    { .name = "[ATA-4] Maxtor DiamondMax 3400",                   .internal_name = "90644D3", .model = "Maxtor 90644D3", .zones =  16,  .avg_spt = 190, .heads = 3, .rpm = 5400, .full_stroke_ms = 20, .track_seek_ms = 0.9,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  32 },
