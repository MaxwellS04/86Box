...
extern int machine_at_mb1212c_init(const machine_t *);
...
extern int machine_at_pmi386sx_init(const machine_t *);
extern int machine_at_sbc350a_init(const machine_t *);
extern int machine_at_auvanpa_init(const machine_t *);
...
extern int machine_at_ser386ad_init(const machine_t *);
...
extern int machine_at_486f30_init(const machine_t *);
...
extern int machine_at_edom495slc_init(const machine_t *);
...
extern int machine_at_ga586at_init(const machine_t *);
...
extern int machine_at_pip55sp4_init(const machine_t *);
...
extern int machine_at_ga586svx_init(const machine_t *);
...
extern int machine_at_586step_init(const machine_t *);
...
extern int machine_at_vp1543_init(const machine_t *);
...
extern int machine_at_hot591p_init(const machine_t *);
...
extern int machine_at_prosignia31x_init(const machine_t *);
extern int machine_at_p6zxt_init(const machine_t *);
...
extern int machine_xt_xturbo_init(const machine_t *);
...
extern int machine_xt_rkvi_init(const machine_t *);
