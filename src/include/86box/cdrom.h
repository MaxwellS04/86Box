...
static const struct cdrom_drive_types_s {
    ...
    /* NOTE: These new CD-ROM models are for 86Box version 4.4 only! */
} cdrom_drive_types[] = {
    ...
    { "ASUS",     "DVD-E616P1",       "1.04", "asus_e616",      BUS_TYPE_IDE,  0, 48, 36, 0, {  4,  2,  2,  4 } },
    ...
    { "GOLDSTAR", "GCD-R542B",        "1.06", "goldstar_542",   BUS_TYPE_IDE,  0,  4, 36, 0, {  3,  2,  2, -1 } }, /* Not much known about this CD-ROM drive. */
    ...
    { "LG",       "CD-ROM CRD-8240B", "1.19", "lg_8240",        BUS_TYPE_IDE,  0, 24, 36, 0, {  4,  2,  2,  2 } },
    ...
    { "LG",       "CD-ROM CRD-8522B", "2.03", "lg_8522",        BUS_TYPE_IDE,  0, 52, 36, 0, {  4,  2,  2,  2 } },
    ...
    { "PIONEER",  "CD-ROM DR-A12X",   "1.01", "pioneer_a12x",   BUS_TYPE_IDE,  0, 12, 36, 0, {  3,  2,  2, -1 } },
    ...
    { "TOSHIBA",  "DVD-ROM SD-M1802", "1051", "toshiba_m1802",  BUS_TYPE_IDE,  0, 48, 96, 0, {  4,  2,  2,  4 } }, /* DVD version of XM-6702B(?) */
